    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="container mx-auto mt-5">
            ...
            <div class="col-12 grid-margin stretch-card mt-3">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample row" method="post" action="{{ route('categories.update', $category->id) }}"
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select text-black" name="show_home" id="show_home">
                                        <option {{ $category->show_home == 'Yes' ? 'selected' : '' }} value="Yes"
                                            class="text-black">Oui</option>
                                        <option {{ $category->show_home == 'No' ? 'selected' : '' }} value="No"
                            ...
                            <div class="col-12">
                                ...
                                @if (!@empty($category->image))
                                    <div class="form-group">
                                        <img src="{{ asset('images/categories/' . $category->image) }}" class="img-fluid"
                                            alt="image">
                                    </div>
                                @else
                                    <div class="form-group">
