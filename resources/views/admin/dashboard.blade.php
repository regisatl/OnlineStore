        ...
        <div class="main-panel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview"
                                            role="tab" aria-controls="overview" aria-selected="true">Aperçu</a>
                                    </li>
                                    <li class="nav-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h5 class="card-subtitle card-subtitle-dash">
                                                                        La courbe montrant la performances éffectué dans la
                                                                        semaine</h5>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <p class="text-small mb-2">Total de visiteurs
                                                                            </p>
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div
                                                                class="d-sm-flex justify-content-between align-items-start">
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">Aperçu du marché
                                                                    </h4>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="#">Action</a>
                                                                            <a class="dropdown-item" href="#">Autre
                                                                                action</a>
                                                                            <a class="dropdown-item" href="#">Autre
                                                                                chose ici</a>
                                                                            <div class="dropdown-divider"></div>
                                                                            <a class="dropdown-item" href="#">Liens
                                                                                séparé</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div
                                                                class="d-sm-flex justify-content-between align-items-start">
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">Demande en
                                                                        attentes</h4>
                                                                    <p class="card-subtitle card-subtitle-dash">Vous avez
                                                                        99+ demandes en attentes</p>
                                                                </div>
                                                                <div>
                                                                    <button
                                                                        class="btn btn-primary btn-lg text-white mb-0 me-0"
                                                                        type="button"><i
                                                                            class="mdi mdi-account-plus"></i>Ajouter un
                                                                        membre</button>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <h4 class="card-title card-title-dash">Tâches à
                                                                            faire</h4>
                                                                                ...
                                                                                <div class="form-check w-100">
                                                                                    <label class="form-check-label">
                                                                                        <input class="checkbox"
                                                                                            type="checkbox"> Liste des
                                                                                        tâches à faire durant sur l'année <i
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <h4 class="card-title card-title-dash">Type par
                                                                            compte</h4>
                                                                    </div>
                                                                    <div>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    ...
                    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright © 2024. Tout droit
                        réservés.</span>
                </div>
            </footer>
            <!-- partial -->
