        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            <ul class="navbar-nav">
                <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                    <h1 class="welcome-text">Bienvenue, <span class="text-black fw-bold"> {{ Auth::guard('admin')->user()->name }} </span></h1>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-bordered dropdown-toggle dropdown-toggle-split" id="messageDropdown"
                        href="#" data-bs-toggle="dropdown" aria-expanded="false"> Catégorie </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        aria-labelledby="messageDropdown">
                        <a class="dropdown-item py-3">
                            <p class="mb-0 fw-medium float-start">Sélectionnez une catégorie</p>
                        </a>
                ...
                <li class="nav-item">
                    <form class="search-form" action="#">
                        ...
                        <input type="search" class="form-control" placeholder="Rechercher ici" title="Rechercher">
                    </form>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        ...
                        <a class="dropdown-item py-3 border-bottom">
                            <p class="mb-0 fw-medium float-start">Vous avez 4 notifications </p>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        ...
                        <a class="dropdown-item py-3">
                            <p class="mb-0 fw-medium float-start">Vous avez 7 mails </p>
                            <span class="badge badge-pill badge-primary float-end">View all</span>
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item preview-item">
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="admin_assets/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                            </div>
                            <div class="preview-item-content flex-grow py-2">
                ...
                <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                            <img class="img-md rounded-circle" src="{{ asset('admin_assets/images/faces/face8.jpg') }}"
                                alt="Profile image">
        ...
        <div class="main-panel">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div
                                                ...
                                                <div>
                                                    <p class="statistics-title">Pages vues</p>
                                                ...
                                                <div class="d-none d-md-block">
                                                    <p class="statistics-title">Moy. Temps passé sur place</p>
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">
                                                                        Graphique des courbes de performances</h4>
                                                                    <h5 class="card-subtitle card-subtitle-dash">
                                                                        La courbe montrant la performances éffectué dans la semaine</h5>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <p class="text-small mb-2">Total de visiteurs</p>
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div
                                                                class="d-sm-flex justify-content-between align-items-start">
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">Aperçu du marché</h4>
                                                                    <p class="card-subtitle card-subtitle-dash">
                                                                       L' aperçu du marché sur une année</p>
                                                                </div>
                                                                <div>
                                                                    <div class="dropdown">
                                                                        <button
                                                                            ...
                                                                            aria-expanded="false"> Le mois
                                                                        </button>
                                                                        <div class="dropdown-menu"
                                                                            aria-labelledby="dropdownMenuButton2">
                                                                            <h6 class="dropdown-header">Paramètres
                                                                            </h6>
                                                    ...
                                                    <div class="card card-rounded">
                                                        <div class="card-body">
                                                            <div
                                                                class="d-sm-flex justify-content-between align-items-start">
                                                                <div>
                                                                    <h4 class="card-title card-title-dash">Demande en attentes</h4>
                                                                    <p class="card-subtitle card-subtitle-dash">Vous avez 99+  demandes en attentes</p>
                                                                </div>
                                                                <div>
                                                                    <button
                                                                        class="btn btn-primary btn-lg text-white mb-0 me-0"
                                                                        type="button"><i
                                                                            class="mdi mdi-account-plus"></i>Ajouter un membre</button>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <table class="table select-table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex ">
                                                                                    <img src="{{ asset('admin_assets/images/faces/face1.jpg') }}"
                                                                                        alt="">
                                                                                    <div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <img src="{{ asset('admin_assets/images/faces/face2.jpg') }}"
                                                                                        alt="">
                                                                                    <div>
                                                                                        <h6>Laura Brooks</h6>
                                                                                        <p>Head admin</p>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <img src="{{ asset('admin_assets/images/faces/face3.jpg') }}"
                                                                                        alt="">
                                                                                    <div>
                                                                                        <h6>Wayne Murphy</h6>
                                                                                        <p>Head admin</p>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <img src="{{ asset('admin_assets/images/faces/face4.jpg') }}"
                                                                                        alt="">
                                                                                    <div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    <img src="{{ asset('admin_assets/images/faces/face5.jpg') }}"
                                                                                        alt="">
                                                                                    <div>
                                                ...
                                                <div class="col-md-6 col-lg-6 grid-margin stretch-card">
                                                    <div class="card card-rounded">
                                                        <div class="card-body card-rounded">
                                                            <h4 class="card-title  card-title-dash"> Evènement Récents
                                                            </h4>
                                                            <div class="list align-items-center border-bottom py-2">
                                                                <div class="wrapper w-100">
                                                                    <p class="mb-2 fw-medium"> Changement de directeurs
                                                                    </p>
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="list align-items-center border-bottom py-2">
                                                                <div class="wrapper w-100">
                                                                    <p class="mb-2 fw-medium"> Autres évènements </p>
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <div class="d-flex align-items-center">
                                                                            <i
                                                            ...
                                                            <div class="list align-items-center border-bottom py-2">
                                                                <div class="wrapper w-100">
                                                                    <p class="mb-2 fw-medium"> Rapport trimestriel
                                                                    </p>
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="list align-items-center pt-3">
                                                                <div class="wrapper w-100">
                                                                    <p class="mb-0">
                                                                        <a href="#"
                                                                            class="fw-bold text-primary">Voir tout
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <h4 class="card-title card-title-dash">Tâches à faire</h4>
                                                                                ...
                                                                                <div class="form-check w-100">
                                                                                    <label class="form-check-label">
                                                                                        <input class="checkbox"
                                                                                            type="checkbox"> Liste des tâches à faire durant sur l'année <i
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div
                                                                        ...
                                                                        <h4 class="card-title card-title-dash">Type par compte</h4>
                                                                    </div>
                                                                    <div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="mt-3">
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{ asset('admin_assets/images/faces/face1.jpg') }}"
                                                                                    alt="profile">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{ asset('admin_assets/images/faces/face2.jpg') }}"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Wayne Murphy</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{ asset('admin_assets/images/faces/face3.jpg') }}"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Katherine Butler</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{ asset('admin_assets/images/faces/face4.jpg') }}"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Matthew Bailey</p>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <img class="img-sm rounded-10"
                                                                                    src="{{ asset('admin_assets/images/faces/face5.jpg') }}"
                                                                                    alt="profile">
                                                                                <div class="wrapper ms-3">
                                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                                        Rafell John</p>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">OnlineStore
                        <a href="mailto:technologieatl22@gmail.com" target="_blank"> ATL TECHNOLOGIE</a></span>
                    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright © 2024. Tout droit réservés.</span>
                </div>
            </footer>
            <!-- partial -->
        </div>
