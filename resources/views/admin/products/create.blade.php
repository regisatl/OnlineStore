    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="container mx-auto mt-5">
            ...
            <div class="col-12 grid-margin stretch-card mt-3">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="post" action="{{ route('products.store') }}" id="productForm"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select text-black" name="category_id" id="category_id">
                                    <!-- Les options de catégorie vont ici -->
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-select text-black" name="sub_category_id" id="sub_category_id">
                                    <!-- Les options de sous-catégorie vont ici -->
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="brand_id">Marque</label>
                                <select class="form-select text-black" name="brand_id" id="brand_id">
                                    <!-- Les options de marque vont ici -->
                                </select>
                            </div>
                            <div class="form-group">
